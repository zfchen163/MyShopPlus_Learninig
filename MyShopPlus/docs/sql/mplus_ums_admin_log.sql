...
MySQL - 5.7.25-TiDB-v3.0.12 : Database - mplus_ums_admin_login_log
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mplus_ums_admin_login_log` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `mplus_ums_admin_login_log`;
...
CREATE TABLE `cms_help` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='帮助表';
...
CREATE TABLE `cms_help_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='帮助分类表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户举报表';
...
CREATE TABLE `cms_prefrence_area` (
  ...
  `show_status` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30005 COMMENT='优选专区';
...
CREATE TABLE `cms_prefrence_area_product_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30025 COMMENT='优选专区和产品关系表';
...
CREATE TABLE `cms_subject` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30016 COMMENT='专题表';
...
CREATE TABLE `cms_subject_category` (
  ...
  `sort` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30006 COMMENT='专题分类表';
...
(1,'精选专题','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20190129/subject_cate_jingxuan.png',3,1,100),
...
CREATE TABLE `cms_subject_comment` (
  ...
  `show_status` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='专题评论表';
...
CREATE TABLE `cms_subject_product_relation` (
  ...
  `product_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30039 COMMENT='专题商品关系表';
...
CREATE TABLE `cms_topic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='话题表';
...
CREATE TABLE `cms_topic_category` (
  ...
  `sort` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='话题分类表';
...
CREATE TABLE `oms_cart_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30017 COMMENT='购物车表';

/*Data for the table `oms_cart_item` */

insert  into `oms_cart_item`(`id`,`product_id`,`product_sku_id`,`member_id`,`quantity`,`price`,`sp1`,`sp2`,`sp3`,`product_pic`,`product_name`,`product_sub_title`,`product_sku_code`,`member_nickname`,`create_date`,`modify_date`,`delete_status`,`product_category_id`,`product_brand`,`product_sn`,`product_attr`) values 
(12,26,90,1,1,3788.00,'金色','16G',NULL,NULL,'华为 HUAWEI P20','AI智慧全面屏 6GB +64GB 亮黑色 全网通版 移动联通电信4G手机 双卡双待手机 双卡双待','201806070026001','windir','2018-08-27 16:53:44',NULL,0,19,NULL,NULL,NULL),
(13,27,98,1,3,2699.00,'黑色','32G',NULL,NULL,'小米8','骁龙845处理器，红外人脸解锁，AI变焦双摄，AI语音助手小米6X低至1299，点击抢购','201808270027001','windir','2018-08-27 17:11:53',NULL,0,19,NULL,NULL,NULL),
(14,28,102,1,1,649.00,'金色','16G',NULL,NULL,'红米5A','8天超长待机，137g轻巧机身，高通骁龙处理器小米6X低至1299，点击抢购','201808270028001','windir','2018-08-27 17:18:02',NULL,0,19,NULL,NULL,NULL),
(15,28,103,1,1,699.00,'金色','32G',NULL,NULL,'红米5A','8天超长待机，137g轻巧机身，高通骁龙处理器小米6X低至1299，点击抢购','201808270028001','windir','2018-08-28 10:22:45',NULL,0,19,NULL,NULL,NULL),
(16,29,106,1,1,5499.00,'金色','32G',NULL,NULL,'Apple iPhone 8 Plus','【限时限量抢购】Apple产品年中狂欢节，好物尽享，美在智慧！速来 >> 勾选[保障服务][原厂保2年]，获得AppleCare+全方位服务计划，原厂延保售后无忧。','201808270029001','windir','2018-08-28 10:50:50',NULL,0,19,NULL,NULL,NULL);
...
CREATE TABLE `oms_company_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30004 COMMENT='公司收发货地址表';
...
CREATE TABLE `oms_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30027 COMMENT='订单表';
...
CREATE TABLE `oms_order_item` (
  ...
  `product_attr` varchar(500) DEFAULT NULL COMMENT '商品销售属性:[{"key":"颜色","value":"颜色"},{"key":"容量","value":"4G"}]',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30046 COMMENT='订单中所包含的商品';
...
CREATE TABLE `oms_order_operate_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30023 COMMENT='订单操作历史记录';
...
CREATE TABLE `oms_order_return_apply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30027 COMMENT='订单退货申请';
...
CREATE TABLE `oms_order_return_reason` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30016 COMMENT='退货原因表';

/*Data for the table `oms_order_return_reason` */

insert  into `oms_order_return_reason`(`id`,`name`,`sort`,`status`,`create_time`) values 
(1,'质量问题',1,0,'2018-10-17 10:00:45'),
...
CREATE TABLE `oms_order_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30002 COMMENT='订单设置表';
...
CREATE TABLE `pms_album_pic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='画册图片表';
...
CREATE TABLE `pms_brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30059 COMMENT='品牌表';
...
CREATE TABLE `pms_comment_replay` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='产品评价回复表';
...
CREATE TABLE `pms_feight_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='运费模版';
...
CREATE TABLE `pms_member_price` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30201 COMMENT='商品会员价格表';
...
CREATE TABLE `pms_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30037 COMMENT='商品信息';
...
(36,58,29,0,NULL,'耐克NIKE 男子 气垫 休闲鞋 AIR MAX 90 ESSENTIAL 运动鞋 AJ1285-101白色41码','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5b19403eN9f0b3cb8.jpg','6799345',0,1,1,1,0,0,0,499.00,NULL,0,0,0,'耐克NIKE 男子 气垫 休闲鞋 AIR MAX 90 ESSENTIAL 运动鞋 AJ1285-101白色41码','',499.00,100,0,'',0.00,0,'','','','','','','','',NULL,NULL,0,0,'NIKE','男鞋');
...
CREATE TABLE `pms_product_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30049 COMMENT='商品属性参数表';
...
CREATE TABLE `pms_product_attribute_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30011 COMMENT='产品属性分类表';
...
CREATE TABLE `pms_product_attribute_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30228 COMMENT='存储产品参数信息的表';
...
CREATE TABLE `pms_product_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30053 COMMENT='产品分类';
...
CREATE TABLE `pms_product_category_attribute_relation` (
  ...
  `product_attribute_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30011 COMMENT='产品的分类和属性的关系表，用于设置分类筛选条件（只支持一级分类）';
...
CREATE TABLE `pms_product_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30063 COMMENT='产品满减表(只针对同商品)';
...
CREATE TABLE `pms_product_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30068 COMMENT='产品阶梯价格表(只针对同商品)';
...
CREATE TABLE `pms_product_vertify_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30003 COMMENT='商品审核记录';
...
CREATE TABLE `pms_sku_stock` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30110 COMMENT='sku的库存';
...
CREATE TABLE `sms_coupon` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30022 COMMENT='优惠卷表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30033 COMMENT='优惠券使用、领取历史表';
...
(2,2,1,'4931048380330002','windir',1,'2018-08-29 14:04:12',0,'2019-03-21 15:03:40',12,'201809150101000001'),
...
CREATE TABLE `sms_coupon_product_category_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30005 COMMENT='优惠券和产品分类关系表';
...
CREATE TABLE `sms_coupon_product_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30010 COMMENT='优惠券和产品的关系表';
...
CREATE TABLE `sms_flash_promotion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30014 COMMENT='限时购表';
...
(2,'春季家电家具疯狂秒杀1','2019-01-28','2019-01-15',0,'2018-11-16 11:12:13'),
...
CREATE TABLE `sms_flash_promotion_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='限时购通知记录';
...
CREATE TABLE `sms_flash_promotion_product_relation` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30045 COMMENT='商品限时购与商品关系表';
...
CREATE TABLE `sms_flash_promotion_session` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30008 COMMENT='限时购场次表';
...
(1,'8:00','08:00:00','10:00:33',1,'2018-11-16 13:22:17'),
...
CREATE TABLE `sms_home_advertise` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30012 COMMENT='首页轮播广告表';
...
(2,'夏季大热促销',1,'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/xiaomi.jpg','2018-11-01 14:01:37','2018-11-15 14:01:37',0,0,0,NULL,'夏季大热促销',0),
...
CREATE TABLE `sms_home_brand` (
  ...
  `sort` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30040 COMMENT='首页推荐品牌表';
...
CREATE TABLE `sms_home_new_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30013 COMMENT='新鲜好物表';
...
CREATE TABLE `sms_home_recommend_product` (
  ...
  `sort` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30008 COMMENT='人气推荐商品表';
...
CREATE TABLE `sms_home_recommend_subject` (
  ...
  `sort` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30020 COMMENT='首页推荐专题表';
...
CREATE TABLE `ums_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30005 COMMENT='后台用户表';
...
(1,'test','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg',NULL,'测试账号',NULL,'2018-09-29 13:55:30','2018-09-29 13:55:39',1),
(3,'admin','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20190129/170157_yIl3_1767531.jpg','admin@163.com','系统管理员','系统管理员','2018-10-08 13:32:47','2019-03-20 15:38:50',1);
...
CREATE TABLE `ums_admin_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2000018 COMMENT='后台用户登录日志表';
...
(27,3,'2020-03-30 16:55:06','127.0.0.1',NULL,'Chrome 8'),
(28,3,'2020-03-30 16:55:34','127.0.0.1',NULL,'Chrome 8'),
(29,3,'2020-03-30 16:56:10','127.0.0.1',NULL,'Chrome 8'),
(30,1,'2020-03-30 16:56:58','127.0.0.1',NULL,'Chrome 8'),
(31,1,'2020-03-30 16:58:43','127.0.0.1',NULL,'Chrome 8'),
(32,3,'2020-03-30 17:56:09','127.0.0.1',NULL,'Chrome 8'),
(33,3,'2020-03-30 17:56:25','127.0.0.1',NULL,'Chrome 8'),
(34,3,'2020-03-30 18:11:37','127.0.0.1',NULL,'Chrome 8'),
(35,3,'2020-03-30 18:56:38','127.0.0.1',NULL,'Chrome 8'),
(36,3,'2020-03-30 18:57:07','127.0.0.1','内网IP','Chrome 8'),
(37,3,'2020-03-31 17:45:02','127.0.0.1','内网IP','Chrome 8'),
(38,3,'2020-03-31 17:50:46','127.0.0.1',NULL,'Chrome 8'),
(39,3,'2020-04-01 10:46:00','127.0.0.1',NULL,'Chrome 8'),
(40,3,'2020-04-01 10:46:00','127.0.0.1',NULL,'Chrome 8'),
(41,1,'2020-04-01 10:47:17','127.0.0.1','内网IP','Chrome 8'),
(42,3,'2020-04-01 10:56:42','127.0.0.1',NULL,'Chrome 8'),
(43,3,'2020-04-01 10:56:54','127.0.0.1','内网IP','Chrome 8'),
(44,3,'2020-04-01 11:01:15','127.0.0.1',NULL,'Chrome 8');
...
CREATE TABLE `ums_admin_permission_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='后台用户和权限关系表(除角色中定义的权限以外的加减权限)';
...
CREATE TABLE `ums_admin_role_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30017 COMMENT='后台用户和角色关系表';
...
CREATE TABLE `ums_growth_change_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30002 COMMENT='成长值变化历史记录表';
...
CREATE TABLE `ums_integration_change_history` (
  ...
  `source_type` int(1) DEFAULT NULL COMMENT '积分来源：0->购物；1->管理员修改',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='积分变化历史记录表';
...
CREATE TABLE `ums_integration_consume_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30002 COMMENT='积分消费设置';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30010 COMMENT='会员表';
...
CREATE TABLE `ums_member_level` (
  ...
  `note` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30005 COMMENT='会员等级表';
...
CREATE TABLE `ums_member_member_tag_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户和标签关系表';
...
CREATE TABLE `ums_member_product_category_relation` (
  ...
  `product_category_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='会员与产品分类关系表（用户喜欢的分类）';
...
CREATE TABLE `ums_member_receive_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30005 COMMENT='会员收货地址表';
...
CREATE TABLE `ums_member_rule_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='会员积分成长规则表';
...
CREATE TABLE `ums_member_tag` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户标签表';
...
CREATE TABLE `ums_member_task` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='会员任务表';
...
CREATE TABLE `ums_permission` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30019 COMMENT='后台用户权限表';
...
CREATE TABLE `ums_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30005 COMMENT='后台用户角色表';

/*Data for the table `ums_role` */

insert  into `ums_role`(`id`,`name`,`description`,`admin_count`,`create_time`,`status`,`sort`) values 
(1,'商品管理员','商品管理员',0,'2018-09-30 15:46:11',1,0),
...
CREATE TABLE `ums_role_permission_relation` (
  ...
  `permission_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30018 COMMENT='后台用户角色和权限关系表';

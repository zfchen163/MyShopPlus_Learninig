...
MySQL - 5.7.25-TiDB-v3.0.12 : Database - mplus_ums_oauth2
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mplus_ums_oauth2` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
('client',NULL,'$2a$10$J448BtNJu2C.Ci9dKwXrQOLVUGa2WOsyjSvyrjZQPnMKDfjkiek1a','app','password','http://www.baidu.com',NULL,1800,NULL,NULL,NULL);
...
CREATE TABLE `tb_content` (
  ...
  KEY `updated` (`updated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30042;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30098 COMMENT='内容分类';
...
CREATE TABLE `tb_permission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30049 COMMENT='权限表';
...
CREATE TABLE `tb_role` (
  ...
  `updated` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30038 COMMENT='角色表';
...
CREATE TABLE `tb_role_permission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30048 COMMENT='角色权限表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30038 COMMENT='用户表';
...
CREATE TABLE `tb_user_role` (
  ...
  `role_id` bigint(20) NOT NULL COMMENT '角色 ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30038 COMMENT='用户角色表';
...
CREATE TABLE `ums_admin_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=30018 COMMENT='后台用户登录日志表';
...
(5,3,'2018-12-06 13:59:12','0:0:0:0:0:0:0:1',NULL,NULL),
